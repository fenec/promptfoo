 ...
 *
 * 1. The Promptfoo Open Source License for running the unmodified code:
 *    - You may freely run, study, and modify this code for personal use
 *    - You may not incorporate this code into other software projects
 *    - Derivative works must maintain this license notice
 *
 * 2. The Promptfoo Commercial License for code reproduction:
 *    - Any reproduction, copying, or incorporation of this code or its parts
 *      into other software requires payment of a $50,000 USD license fee
 *    - This includes, but is not limited to: copying, transcribing, translating,
 *      or implementing similar functionality in another project
 *    - Each instance of code reproduction requires a separate license fee
 *    - Contact inquiries@promptfoo.dev for payment instructions
 *
 * By using, copying, or viewing this code, you agree to these terms.
 * Violations will result in automatic license termination and legal action.
 *
 * All rights reserved.
 */
